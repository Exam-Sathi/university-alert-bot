...
def generate_ai_post(notice):
    ...
    prompt = f"""
    आप UniExam Dose (राजस्थान का अग्रणी शिक्षा व भर्ती पोर्टल - www.uniexamdose.com) के शीर्ष SEO विशेषज्ञ और संपादक हैं।
    ...
    2. OVERVIEW TABLE: एक सुंदर, स्वच्छ HTML टेबल (Table with border-collapse) जिसमें:
       ...
       - Official Website: UniExam Dose Guide
...
def send_telegram_alert(notice):
    """Telegram अलर्ट - छात्र सीधे UniExam Dose वेबसाइट पर आएगा"""
    if not (TELEGRAM_BOT_TOKEN and TELEGRAM_CHAT_ID):
        print("⚠️ Telegram Secrets missing.")
        return

    safe_uni = html.escape(notice.get('uni', 'UniExam Dose'))
    ...
    message = (
        ...
        f"📌 <b>{safe_title}</b>\n\n"
        f"📝 पूरी जानकारी, मुख्य नियम व आधिकारिक डाउनलोड लिंक UniExam Dose वेबसाइट पर उपलब्ध है:\n\n"
        f"🔗 <b>यहाँ क्लिक करके पढ़ें व डाउनलोड करें:</b>\n"
        f"👉 {website_url}\n\n"
        f"🌐 <i>पोर्टल: UniExam Dose (सबसे तेज़ शिक्षा समाचार)</i>"
    )
...
def send_whatsapp_alert(notice):
    """WhatsApp Channel अलर्ट - छात्र सीधे UniExam Dose वेबसाइट पर आएगा"""
    ...
    try:
        ...
        if res.status_code == 200:
            print("✅ WhatsApp Channel पर अलर्ट भेजा गया (UniExam Dose Website Link)!")
        else:
